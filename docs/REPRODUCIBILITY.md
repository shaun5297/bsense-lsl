...
- M7 正式流程包含 180 个 `p300_trial_start`、5,400 个 `p300_flash`、180 个 `p300_command`；每个 Trial 恰有 5 个完整 Sequence，每个 Sequence 六个位置各出现一次且恰有一个 `is_target=true`；Raw NASA-TLX 六个字段均已提交；
