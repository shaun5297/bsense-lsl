...
- 提供赛道7“脑状态安检”预设：KSS/睡眠背景、EEG 质量门控、睁眼基线、3 分钟 SART 和四态结果；
...
| 赛道7：脑状态安检 | M6 | 约 4.7 分钟，另加状态确认 | 上岗前当班状态筛查；使用独立当次基线，不依赖 M0 |
...
| `m6_readiness` | M6 脑状态安检 | EEG 质量门控、睁眼当次基线、3 分钟 SART 与四态筛查结果 |
